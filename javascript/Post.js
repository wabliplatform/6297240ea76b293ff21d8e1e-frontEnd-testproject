let apiPostApi = new TempApi.PostApi();import TempApi from '../src/index';let post = new TempApi.Post();
...
$(
    ...
    );document.getElementById('i7lnh').onclick = (event) => {
    ...
    post['pimage'] = {
      ...
      post['ptext'] = document.querySelector("[annotationname = 'ptext']").value;post['ptitle'] = document.querySelector("[annotationname = 'ptitle']").value;apiPostApi.createpost( post, (error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); {  location.href= '/Home/'+response.body.query._id+'' ;}}});};window.onload = () => {};